...
resource "aws_eks_node_group" "main" {
  ...
  tags = merge(var.tags, { Name = "${var.project_name}-node-group" })
}
...
resource "aws_iam_openid_connect_provider" "eks" {
  ...
  tags = merge(var.tags, { Name = "${var.project_name}-eks-irsa" })
}
...
resource "tls_self_signed_cert" "self_signed" {
  ...
  subject {
    ...
    organization = "Nginx IaC Deployment"
  }
...
resource "aws_acm_certificate" "self_signed" {
  ...
  tags = merge(var.tags, { Name = "${var.project_name}-self-signed-cert" })
}
